...
\newcommand{\PrevalenceGeneral}{\begin{table*}
    ...
    \caption{\textbf{\textbf{Global view of bidirectional censorship broken down by protocol}\,---\,}
            ...
            we represent the percent of vantage points in that country (IPv4 / IPv6) that returned a
            censorship result. We omit numbers if they are below a threshold for both IPv4 and IPv6, indicating that our bidirectional censorship measurement technique did not observe that protocol blocked in the specified country.
