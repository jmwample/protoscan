...
\newcommand{\FigProbeSend}{
    \begin{figure}[t]
     \centering
     \includegraphics[width=0.95\linewidth]{figures/probe_send_0.2.pdf}
     \caption{\textbf{Sending Probes}\,---\,%
            For each protocol tested we send probes to addresses where we do not
            expect responses. When a passive censor monitoring traffic along the
